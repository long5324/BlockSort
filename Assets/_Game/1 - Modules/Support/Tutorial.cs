...
namespace HumanSort
{
    ...
    public class Tutorial : Singleton<Tutorial>
    {
        ...
        [SerializeField] private Image handRender;
        ...
        [Header("Area Button")]
        [SerializeField] private Image buttonArea;
        ...
        private void Awake()
        {
            ...
            handRenderRotation = handRender.transform.localEulerAngles;
        }

        public void AreaButton(Vector3 worldPosition, Action btnAction)
        {
            buttonArea.gameObject.SetActive(true);
            Vector3 UIPosition = Help.ConvertWorldToUIPosition(worldPosition, GameManager.Ins.MainCanvasRect);
        ...
        public void WorldClick(Vector3 worldPosition, Vector3 rotation, float offset)
        {
            ...
            Vector3 startPosition = Help.ConvertWorldToUIPosition(worldPosition, GameManager.Ins.MainCanvasRect);
            ...
            float yRenderDirection = 0;
            yRenderDirection = rotation.z > 0 ? 0 : 180;
 
            handRender.transform.DOLocalRotate(handRenderRotation + new Vector3(0, yRenderDirection, 5), 0.5f)
                                .From(handRenderRotation - new Vector3(0, yRenderDirection, 5))
                                .SetLoops(-1, LoopType.Yoyo)
                                .SetEase(Ease.Linear);
        }
        ...
        public void WorldDrag(Vector3 starPosition, Vector3 endPosition, Vector3 rotation, float moveTime = 2)
        {
            hand.DOKill();
            hand.gameObject.SetActive(true);
            Vector3 start = Help.ConvertWorldToUIPosition(starPosition, GameManager.Ins.MainCanvasRect);
            Vector3 end = Help.ConvertWorldToUIPosition(endPosition, GameManager.Ins.MainCanvasRect);
        ...
        public void UIDrag(Vector3 starPosition, Vector3 endPosition, Vector3 rotation, float moveTime = 2, Transform parent = null)
        {
            hand.DOKill();
            hand.gameObject.SetActive(true);
